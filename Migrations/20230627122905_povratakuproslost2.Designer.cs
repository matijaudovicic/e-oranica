...
{
    [DbContext(typeof(EoranicaContext))]
    [Migration("20230627122905_povratakuproslost2")]
    partial class povratakuproslost2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eoranica.Models.Chore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.ChorePerson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.ChoreStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.ContractPlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.GoodsType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Ground", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.IncomeAndExpense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Plant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.PlantPassport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.PlantType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Plot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.Terrain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Eoranica.Models.ChorePerson", b =>
                {
                    b.HasOne("Eoranica.Models.Chore", "Chore")
                    ...
                    b.HasOne("Eoranica.Models.OrderStatus", "OrderStatus")
                        .WithMany("ChorePeople")
                    ...
                    b.HasOne("Eoranica.Models.Person", "Person")
                        .WithMany("ChorePeople")
            ...
            modelBuilder.Entity("Eoranica.Models.City", b =>
                {
                    b.HasOne("Eoranica.Models.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Eoranica.Models.Contract", b =>
                {
                    b.HasOne("Eoranica.Models.Person", "Beneficiary")
                    ...
                    b.HasOne("Eoranica.Models.Person", "Provider")
            ...
            modelBuilder.Entity("Eoranica.Models.ContractPlot", b =>
                {
                    b.HasOne("Eoranica.Models.Contract", "Contract")
                        .WithMany("ContractPlots")
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK__contract___contr__5DCAEF64");

                    b.HasOne("Eoranica.Models.Plot", "Plot")
                        .WithMany("ContractPlots")
            ...
            modelBuilder.Entity("Eoranica.Models.IncomeAndExpense", b =>
                {
                    b.HasOne("Eoranica.Models.Plant", "Plant")
            ...
            modelBuilder.Entity("Eoranica.Models.Order", b =>
                {
                    b.HasOne("Eoranica.Models.Person", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Eoranica.Models.Person", b =>
                {
                    b.HasOne("Eoranica.Models.City", "City")
                        .WithMany("People")
                        .HasForeignKey("CityId")
                        .HasConstraintName("FK__person__city_id__6477ECF3");

                    b.HasOne("Eoranica.Models.Role", "Role")
                        .WithMany("People")
            ...
            modelBuilder.Entity("Eoranica.Models.Plant", b =>
                {
                    b.HasOne("Eoranica.Models.GoodsType", "GoodsType")
                        .WithMany("Plants")
                        .HasForeignKey("GoodsTypeId")
                        .HasConstraintName("FK__plant__goods_typ__66603565");

                    b.HasOne("Eoranica.Models.Person", "Manufacturer")
                        .WithMany("Plants")
                        .HasForeignKey("ManufacturerId")
                        .HasConstraintName("FK__plant__manufactu__6754599E");

                    b.HasOne("Eoranica.Models.PlantType", "PlantType")
                        .WithMany("Plants")
