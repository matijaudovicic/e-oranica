...
namespace Eoranica.Controllers
{
    public class ChorePersonsController : Controller
    {
        ...
        public ChorePersonsController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        {
            var EoranicaContext = _context.ChorePeople.Include(c => c.Chore).Include(c => c.OrderStatus).Include(c => c.Person);
        ...
        {
            ViewData["ChoreId"] = new SelectList(_context.Chores, "Id", "Name");
        ...
        {
            ViewData["ChoreId"] = new SelectList(_context.Chores, "Id", "Name", chorePerson.ChoreId);
            ViewData["OrderStatusId"] = new SelectList(_context.OrderStatuses, "Id", "Name", chorePerson.OrderStatusId);
            ViewData["PersonId"] = new SelectList(_context.People, "Id", "FullName", chorePerson.PersonId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.ChorePeople'  is null.");
            }
            var chorePerson = await _context.ChorePeople.FindAsync(id);
            if (chorePerson != null)
            {
