...
namespace Eoranica.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public OrderStatusController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.OrderStatuses != null ? 
                          ...
                          Problem("Entity set 'EoranicaContext.OrderStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.OrderStatuses'  is null.");
            }
            var orderStatus = await _context.OrderStatuses.FindAsync(id);
            if (orderStatus != null)
            {
