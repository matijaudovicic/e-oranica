...
namespace Eoranica.Controllers
{
    public class ChoreStatusController : Controller
    {
        ...
        public ChoreStatusController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ChoreStatuses != null ? 
                          ...
                          Problem("Entity set 'EoranicaContext.ChoreStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.ChoreStatuses'  is null.");
            }
            var choreStatus = await _context.ChoreStatuses.FindAsync(id);
            if (choreStatus != null)
            {
