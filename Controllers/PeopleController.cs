...
namespace Eoranica.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public PeopleController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        {
            var EoranicaContext = _context.People.Include(p => p.City).Include(p => p.Role);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.People'  is null.");
            }
            var person = await _context.People.FindAsync(id);
            if (person != null)
            {
