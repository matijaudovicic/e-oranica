...
namespace Eoranica.Controllers
{
    public class PlotsController : Controller
    {
        ...
        public PlotsController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        {
            var EoranicaContext = _context.Plots.Include(p => p.Ground).Include(p => p.Owner).Include(p => p.Terrain);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.Plots'  is null.");
            }
            var plot = await _context.Plots.FindAsync(id);
            if (plot != null)
            {
