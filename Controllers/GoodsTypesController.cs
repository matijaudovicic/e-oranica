...
namespace Eoranica.Controllers
{
    public class GoodsTypesController : Controller
    {
        ...
        public GoodsTypesController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.GoodsTypes != null ? 
                          ...
                          Problem("Entity set 'EoranicaContext.GoodsTypes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,MeasurementUnit,Quantity")] GoodsType goodsType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,MeasurementUnit,Quantity")] GoodsType goodsType)
        {
            if (id != goodsType.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.GoodsTypes'  is null.");
            }
            var goodsType = await _context.GoodsTypes.FindAsync(id);
            if (goodsType != null)
            {
