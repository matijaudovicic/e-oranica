...
namespace Eoranica.Controllers
{
    public class IncomeAndExpensesController : Controller
    {
        ...
        public IncomeAndExpensesController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        {
            var EoranicaContext = _context.IncomeAndExpenses.Include(i => i.Plant).Include(i => i.Plot);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.IncomeAndExpenses'  is null.");
            }
            var incomeAndExpense = await _context.IncomeAndExpenses.FindAsync(id);
            if (incomeAndExpense != null)
            {
