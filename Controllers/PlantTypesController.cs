...
namespace Eoranica.Controllers
{
    public class PlantTypesController : Controller
    {
        ...
        public PlantTypesController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.PlantTypes != null ? 
                          ...
                          Problem("Entity set 'EoranicaContext.PlantTypes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.PlantTypes'  is null.");
            }
            var plantType = await _context.PlantTypes.FindAsync(id);
            if (plantType != null)
            {
