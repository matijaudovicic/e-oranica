...
namespace Eoranica.Controllers
{
    public class ContractsController : Controller
    {
        ...
        public ContractsController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        {
            var EoranicaContext = _context.Contracts.Include(c => c.Beneficiary).Include(c => c.Provider);
...
if (contract.ProviderId != null)
{
    ViewBag.ProviderId = new SelectList(_context.People, "Id", "FullName", contract.ProviderId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.Contracts'  is null.");
            }
            var contract = await _context.Contracts.FindAsync(id);
            if (contract != null)
            {
