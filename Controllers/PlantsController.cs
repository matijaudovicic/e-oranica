...
namespace Eoranica.Controllers
{
    public class PlantsController : Controller
    {
        ...
        public PlantsController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        {
            var EoranicaContext = _context.Plants.Include(p => p.GoodsType).Include(p => p.Manufacturer).Include(p => p.PlantType);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.Plants'  is null.");
            }
            var plant = await _context.Plants.FindAsync(id);
            if (plant != null)
            {
