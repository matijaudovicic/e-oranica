...
namespace Eoranica.Controllers
{
    public class GroundsController : Controller
    {
        ...
        public GroundsController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Grounds != null ? 
                          ...
                          Problem("Entity set 'EoranicaContext.Grounds'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.Grounds'  is null.");
            }
            var ground = await _context.Grounds.FindAsync(id);
            if (ground != null)
            {
