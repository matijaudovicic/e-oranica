...
namespace Eoranica.Controllers
{
    public class TerrainsController : Controller
    {
        ...
        public TerrainsController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Terrains != null ? 
                          ...
                          Problem("Entity set 'EoranicaContext.Terrains'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.Terrains'  is null.");
            }
            var terrain = await _context.Terrains.FindAsync(id);
            if (terrain != null)
            {
