...
namespace Eoranica.Controllers
{
    public class ChoresController : Controller
    {
        ...
        public ChoresController(EoranicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Chores != null ? 
                          ...
                          Problem("Entity set 'EoranicaContext.Chores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EoranicaContext.Chores'  is null.");
            }
            var chore = await _context.Chores.FindAsync(id);
            if (chore != null)
            {
