...
public partial class EoranicaContext : DbContext
{
    public EoranicaContext(DbContextOptionsBuilder<EoranicaContext> options)
    {
    }

    public EoranicaContext(DbContextOptions<EoranicaContext> options)
        : base(options)
    {
    }
